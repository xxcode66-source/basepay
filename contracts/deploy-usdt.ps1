...
Write-Host ""
Write-Host "=== Deploying TipRouterUSDT to Base Mainnet ===" -ForegroundColor Cyan
Write-Host ""
Write-Host "  USDT:     0xfde4C96c8593536E31F229EA8f37b2ADa2699bb2" -ForegroundColor Gray
...
$args = @(
    "create",
    "src/TipRouterUSDT.sol:TipRouterUSDT",
...
$args += "0xfde4C96c8593536E31F229EA8f37b2ADa2699bb2"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "  2. Paste into frontend/.env.local as NEXT_PUBLIC_TIP_ROUTER_USDT_ADDRESS"
